...
@meta.description: Molehill CMS is a simple, extensible, customizable, file-based content management system written in PHP.
@template: hero
...
It's a simple, extensible, customizable, file-based content management system
written in PHP.
